...
Georgia Tech facing a significant downtick in attendance from 2019 to 2024 is a bit surprising, considering that Brent Key somewhat revitalized the program in his first year as head coach in 2023. The Yellow Jackets had three consecutive three-win seasons from 2019-2021, which would explain a decrease in attendance during those years, but seeing the attendance not bounce back in 2024 is unexpected.
