...
Who do you get as the first result, and what was his true shooting percentage?

Julian Reese led Maryland in true shooting percentage at .599 TS%. This is due to him shooting 55.5% from the field because he was a post player that usually took shots within a few feet of the rim.
...
Let's return to our women's soccer data. I've updated the data through Sept. 7, so we've got more matches now. Let's load it:
...
```
Now it's your turn: do the same for the 2024 data. Load it from GitHub, then adapt the above code but add an additional filter to restrict the results to Maryland's first seven games (the 7th game was on Sept. 5, 2024). You need to put the date value in quotes in this format: 'yyyy-mm-dd'
...
How do the two years compare?

Maryland's total shot attempts, shots on goal, and shots on goal percentage in the first seven games of 2025 are considerably higher than the numbers the team produced in 2024. The shots on goal percentage in 2025 is roughly 10 percentage points higher than the year prior, and the team has notched 12 more shots on goal through seven games this season compared to last.